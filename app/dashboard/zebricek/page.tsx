...
export default function ZebricekPage() {
  ...
  if (isParticipant === false) {
    return (
      <div className="min-h-[50vh] flex items-center justify-center">
        <div className="rounded-2xl p-8 max-w-md w-full text-center border border-gray-200 dark:border-gray-700 shadow-lg" style={{ backgroundColor: theme === 'dark' ? 'rgba(30, 41, 59, 0.7)' : 'rgba(255, 255, 255, 0.7)' }}>
  ...
  if (tournament?.leaderboard_closed) {
    return (
      <div>
        ...
        <div className="rounded-2xl p-8 border border-gray-200 dark:border-border-dark shadow-sm text-center" style={{ backgroundColor: theme === 'dark' ? 'rgba(26, 39, 64, 0.7)' : 'rgba(255, 255, 255, 0.7)' }}>
          <div className="flex justify-center mb-4">
            <Image 
  ...
  return (
    <div>
      <h1 className="text-[32px] leading-[40px] font-semibold text-text-primary dark:text-white mb-6">Žebříček</h1>
      <div className="rounded-2xl shadow-sm border border-gray-200 dark:border-border-dark overflow-hidden" style={{ backgroundColor: theme === 'dark' ? 'rgba(26, 39, 64, 0.7)' : 'rgba(255, 255, 255, 0.7)' }}>
        {/* Hlavička tabulky */}
