  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        <div className="bg-white/70 dark:bg-card-dark/70 rounded-2xl p-5 border border-gray-200 dark:border-border-dark shadow-sm text-center !bg-white/70 dark:!bg-card-dark/70">
      ...
      {/* Detailní statistiky */}
      <div className="bg-white/70 dark:bg-card-dark/70 rounded-2xl border border-gray-200 dark:border-border-dark shadow-sm overflow-hidden mb-6 !bg-white/70 dark:!bg-card-dark/70">
      ...
      {/* Bodovací systém */}
      <div className="bg-white/70 dark:bg-card-dark/70 rounded-2xl border border-gray-200 dark:border-border-dark shadow-sm p-5 !bg-white/70 dark:!bg-card-dark/70">
